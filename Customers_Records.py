...
#Get customers_lists from records, this is for every customer has entered the system in total . 
...
if TodaysDate not in Customer_Record_df["Date"].values:
    Date_df = pandas.DataFrame({"Date": [TodaysDate]})
    print(Date_df)
    Customer_Record_df = Customer_Record_df._append(Date_df)
